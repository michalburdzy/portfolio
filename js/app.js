window.onload = function() {
  ...
  window.addEventListener("scroll", function() {
    ...
    var position_contact = viewportWidth / 0.47;
    if (
      positionY > position_projects &&
      !projectsSection.classList.contains("visible")
    ) {
    ...
    if (
      positionY > position_contact &&
      !contactForm.classList.contains("animation-appear")
    ) {
      contactForm.classList.add("animation-appear");
